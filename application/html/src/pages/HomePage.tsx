  ...
  return (
    <>
      <Flex alignItems="center" class="flex-col xl:flex-row mb-6 px-4 py-2">
        ...
        <Flex class="flex-col lg:flex-row justify-center lg:justify-between gap-y-2 mb-4">
          ...
          <div class="shrink-0 lg:hidden">
            <form use:form>
              <span class="text-xl mr-2">Search:</span>
              <Flex class="sm:inline">
                <input
                  name="search"
                  class="max-w-64 w-full sm:w-auto px-4 py-2 rounded-full text-gray-600 focus:outline-none border focus:border-gray-600"
                  type="text"
                  placeholder="tracking #, carrier, status..."
                />
                <button type="submit" class="ml-2 focus:outline-none">
