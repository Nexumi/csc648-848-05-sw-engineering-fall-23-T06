  ...
  return (
      <>
        <Flex alignItems="center" class="flex-col xl:flex-row mb-6 px-4 py-2">
          ...
          <Flex class="flex-col lg:flex-row justify-center lg:justify-between md:gap-y-4 gap-y-1.5 mb-4">
            ...
            <div class="shrink-0">
              <form use:form>
                <span class="text-xl md:mr-2 mr-2 md:block hidden">Search:</span>
                <div class="sm:inline">
                  <input name="search" class="md:block hidden w-64 px-4 py-2 rounded-full text-gray-600 focus:outline-none border focus:border-gray-600" type="text" placeholder="tracking #, carrier, status..." />
                  <button type="submit" class="md:block hidden ml-2 focus:outline-none">
            ...
            <Flex justifyContent="center" class="flex-col sm:flex-row w-full max-w-xs sm:w-auto gap-x-4 gap-y-2">
              ...
              <Flex class="md:flex md:flex-col md:hidden ml-14">
                <Flex class="md:shrink-0">
                  <form use:form>
                    <span className="text-xl md:mr-2">Search:</span>
                    <input
                        name="search"
                        class="md:w-64 w-40 px-2 py-1 rounded-full text-sm text-gray-600 focus:outline-none border focus:border-gray-600"
                        type="text"
